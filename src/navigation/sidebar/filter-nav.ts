...
function passes(perms: Set<string>, item: { requiredAny?: string[]; requiredAll?: string[] }, mode: Mode) {
...
export function filterNavGroups(groups: NavGroup[], userPermsArray: string[], mode: Mode = DEFAULT_MODE): NavGroup[] {
