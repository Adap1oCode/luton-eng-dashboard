// -----------------------------------------------------------------------------
// FILE: src/app/(main)/forms/inventory-unique/page.tsx
// TYPE: Server Component (SSR)
// PURPOSE: Read-only list screen for v_inventory_unique view
// -----------------------------------------------------------------------------
...
import { config, RESOURCE_KEY } from "./inventory-unique.config";
import { toRow } from "./to-row";
import { InventoryUniqueTableClient } from "./inventory-unique-table-client";
