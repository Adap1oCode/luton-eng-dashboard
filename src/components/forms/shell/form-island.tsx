...
/**
 * FormIsland - Wrapper component that handles form submission and passes options to DynamicForm.
 * 
 * Options are passed directly from parent without modification.
 * Pattern: Server loads options → passes to EditWithTabs → passes to FormIsland → passes to DynamicForm.
 */
