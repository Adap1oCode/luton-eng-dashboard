...
type Props = {
  data: any[]
  columns: ColumnDefSimple[]
  rowIdKey?: string // ✅ NEW: optional override for row ID field
}

export function DataTable({ data: initialData, columns, rowIdKey = 'id' }: Props) {
...
React.useEffect(() => {
  ...
  const table = useDataTableInstance({
    data,
    columns: fullColumns,
    getRowId: (row) => row[rowIdKey], // ✅ Dynamic row ID
  })
