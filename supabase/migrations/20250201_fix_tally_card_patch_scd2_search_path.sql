-- ============================================================================
-- Migration: Create/Update fn_tally_card_patch_scd2 function
-- Date: 2025-02-01
-- Purpose: Create the function with proper search_path setting (based on working fn_user_entry_patch_scd2 pattern)
-- ============================================================================

-- Drop function if it exists (in case it was created without proper settings)
...
-- EXACT PATTERN from fn_user_entry_patch_scd2, adapted for tally cards (no updated_by_user_id)
