...
vi.mock('@/components/forms/shell/form-shell-with-loading', () => ({
  default: function MockFormShellWithLoading({ 
    title, 
    headerTitle, 
    headerDescription, 
    actions, 
    ...
    return (
      <div data-testid="form-shell-with-loading">
        ...
        <div data-testid="form-actions">{actions ? 'actions-present' : 'no-actions'}</div>
...
vi.mock('@/components/forms/shell/form-island', () => ({
  default: function MockFormIsland({ formId, config, defaults, options }: any) {
    return (
...
vi.mock('@/components/auth/permissions-gate', () => ({
  PermissionGate: function MockPermissionGate({ children, any: anyPermissions, all: allPermissions }: any) {
    return (
...
describe('ResourceFormSSRPage Loading States', () => {
  ...
  it('uses default loading messages when not provided', () => {
    ...
    const submissionLoading = screen.getByTestId('submission-loading');
    expect(submissionLoading).toHaveAttribute('data-title', 'Saving Changes');
    expect(submissionLoading).toHaveAttribute('data-description', 'Please wait...');
  ...
  it('handles permission gating for primary button', () => {
    ...
    expect(actions).toHaveTextContent('actions-present');
  });
