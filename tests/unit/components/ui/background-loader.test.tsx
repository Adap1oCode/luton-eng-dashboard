...
describe('BackgroundLoader', () => {
  ...
  it('applies custom className', () => {
    ...
    const loader = screen.getByText('Updating...').closest('div');
  ...
  it('has proper positioning classes', () => {
    const { rerender } = render(<BackgroundLoader position="top-right" />);
    let loader = screen.getByText('Updating...').closest('div');
    expect(loader).toHaveClass('top-4', 'right-4');
    
    rerender(<BackgroundLoader position="top-left" />);
    loader = screen.getByText('Updating...').closest('div');
  ...
  it('handles empty message gracefully', () => {
    ...
    const container = screen.getByRole('generic').closest('.bg-white');
